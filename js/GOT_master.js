(() => {
	...
	function showHideLightbox() {
		...
		// load the right video, and then play Interval
		let house = this.classList[1], // star, baratheon, lannister etc
		...
		if (lbVideo.paused) {
			...
			// ligthbox is open and we want the video to rewind and stop when we close it.
